...
- **E2E testing:** `docs/e2e-testing.md` - Test framework, running tests, writing scenarios, video recording (`--record`, issue #621), automatic proof-video cleanup (daily sweep, 3-day grace after PR close)
