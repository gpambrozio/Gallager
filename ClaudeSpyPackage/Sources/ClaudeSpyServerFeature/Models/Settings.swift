...
final public class AppSettings {
    ...
    /// Whether yolo mode is enabled (auto-approve permission requests except AskUserQuestion)
    public var yoloMode: Bool = Defaults.yoloMode {
        didSet { preferences.setBool(yoloMode, Keys.yoloMode) }
    }
    ...
    public init() {
        ...
        self.yoloMode = preferences.optionalBool(Keys.yoloMode) ?? Defaults.yoloMode
