    ...
    final class InteractiveTerminalView: NSView {
        ...
        /// stale entry — otherwise a click on a cell whose visible content has
        ...
        private func urlClosures(for terminal: Terminal) -> (
            ...
            return (
                ...
                cellPayload: { col, row in payloads[row + yDisp]?[col]?.payload }
            )
        }
        ...
        /// leave the stale payload in the cache, so a click on the cell's new
