...
struct MainViewMenuCommandsModifier: ViewModifier {
...
struct MainViewEditorPickerDialogModifier: ViewModifier {
...
/// Hosts the attach-error and close-confirmation alerts plus the editor
/// launch-failure listener. Bundled into a single modifier so `MainView.body`
/// stays under the SwiftUI type-checker threshold.
struct MainViewAlertsModifier: ViewModifier {
