...
/// 2. Creates a tmux session and renders three tables using a Python script:
///    - Table 1: Simple emoji-only table (varying emoji counts per row)
///    - Table 2: Mixed text and emoji with colored headers
///    - Table 3: Wide table with multiple columns, text, and sparse emoji
...
public enum EmojiTableRenderingScenario {
    public static let scenario = ClaudeSpyE2ELib.scenario(
        ...
        TestStep.tmuxCreateSession(name: "emoji-tbl", width: 100, height: 40)
        ...
        TestStep.tmuxSendKeys(
            ...
            def table2():
                ...
                data=[
                    ...
                    ("4","Diana",f"Busy {C}33m\U0001f7e1{C}0m","In meeting"),
                    ("5","Eve",f"Active {C}32m\U0001f7e2{C}0m",f"Team lead \U0001f451"),
                    ("6","Frank",f"Away {C}31m\U0001f534{C}0m","Sick leave"),
                    ("7","Grace",f"Busy {C}33m\U0001f7e1{C}0m",f"Presenting \U0001f3a4"),
                ]
                for row in data:
                    o("\u2502")
            ...
            def table3():
                ...
                grid=[
                    ["\U0001f600","\U0001f60e","\U0001f914","\U0001f631","\U0001f973","\U0001f634"],
                    ["\U0001f525","\U0001f4a7","\u2744\ufe0f","\U0001f338","\U0001f340","\U0001f319"],
                    ["\U0001f680","\u2708\ufe0f","\U0001f682","\U0001f681","\U0001f6f8","\U0001f6a2"],
                    ["\u26bd","\U0001f3c0","\U0001f3be","\U0001f3c8","\u26be","\U0001f3b1"],
                ]
                w=4
                ncols=len(grid[0])
                # top
